...
export default function CriarAnuncio() {
    ...
    const schema = yup.object().shape({
        ...
        exm_autor: yup
            .string()
            .required('O autor do exemplar é obrigatório!'),
        exm_editora: yup
            .string()
    ...
    return (
        ...
        <Formik
        initialValues={{exm_titulo: '', exm_genero: '', exm_autor: '', exm_editora: '', anc_descricao: '', image:''}}
    ...
    {({ handleChange, handleSubmit, values, errors, touched }) => (
        ...
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.form}>
                    ...
                    <Text onPress={handleSubmit} style={styles.btnSubmitText}>{loading ? 'Criando...' : 'Criar anúncio'}</Text>
                    </TouchableOpacity>
                </View>
        </KeyboardAvoidingView>
    )}
