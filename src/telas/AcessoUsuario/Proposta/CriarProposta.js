...
export default function CriarProposta({ route }) {
    ...
    useEffect(() => console.log(route.params?.anc_id))
    ...
    async function handleFormData(values) {
        const dataProposta = {
            prop_descricao: values.prop_descricao,
        }
        ...
        return [ dataExemplar, dataImagens, dataProposta ];
    }
                ...
                <KeyboardAvoidingView style={styles.container} keyboardVerticalOffset={80}>
                    ...
                    <View style={styles.form}>
                        ...
                        <TextInput
                            ...
                            autoCorrect={false}
                            value={values.prop_descricao}
                            onChangeText={handleChange('prop_descricao')}
                        />
